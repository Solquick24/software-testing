...
describe("processOrder", () => {
  ...
  test("price가 숫자가 아니면 에러 발생", () => {
    ...
    expect(() =>
      processOrder(mockApi, { price: "50000", userId: 1 })
  ...
  test("price >= 50000이면 할인 알림 호출", () => {
    ...
    expect(mockApi.sendDiscountNotification).toHaveBeenCalledTimes(1);
  ...
  test("price < 50000이면 기본 알림 호출", () => {
    ...
    expect(mockApi.sendBasicNotification).toHaveBeenCalledTimes(1);
